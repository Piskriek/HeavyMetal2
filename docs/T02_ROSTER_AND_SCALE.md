...
Status: recovered onto `arena/01a0c9fa-heavymetal2` from the previous agent's workspace dump and opened as a draft PR. Issue: [#35](https://github.com/Piskriek/HeavyMetal2/issues/35).
Builds directly on the frozen T01 contracts (`src/game/contracts/`, `docs/CONTRACTS.md`). Those contracts are included in this branch because current `main` (`f4c2dcb`) does not share history with PR #46.
