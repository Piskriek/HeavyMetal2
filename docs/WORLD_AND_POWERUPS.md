...
All courses now run 36 km and retain a four-lane start and stadium finish. The first 12 km is the established downhill; the 12 km Section 2 waterfall cliff adds wet wooden switchbacks, pinball bumpers, spring launches, fire-ring routes, and recovery gaps; the final 12 km is the cavern approach and stadium finale. Each course has its own elevation profile, sector names, obstacle placement rhythm, and pickup route. The forest/canyon/meadow choice is not just a background tint.
