...
| [`TICKET-06`](file:///c:/MarbleGp/docs/tickets/TICKET-06-track-backgrounds-lighting-preloading.md) | [#8](https://github.com/Piskriek/HeavyMetal2/issues/8) | Epic Blizzard Track Backdrops, Thematic Lighting & Asset Preloading | **P1** | Environment / Asset Pipeline | `TICKET-05` | **Merged** |
| [`TICKET-06.2`](file:///c:/MarbleGp/docs/tickets/TICKET-06.2-midground-environmental-depth-layers.md) | — | Midground Environmental Depth Layers (Treetops, Props & Crowd Separation) | **P1** | Environment / Multi-Plane Parallax | `TICKET-06` | **Completed** |
