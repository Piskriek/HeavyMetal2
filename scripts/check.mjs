...
const commands = [
  ...
  ['--import', 'tsx', '--test', '--test-reporter=tap', '--test-reporter-destination=stdout',
    ...
    'tests/cockpit.test.ts', 'tests/scene-kit.test.ts', 'tests/painted-icons.test.ts', 'tests/painted-parts.test.ts',
    ...
    'tests/effects.test.ts', 'tests/depth-mask.test.ts', 'tests/painted-goblin.test.ts', 'tests/route-graph.test.ts', 'tests/route-layout.test.ts',
