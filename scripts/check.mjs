...
const commands = [
  ...
  ['--import', 'tsx', '--test', '--test-reporter=tap', '--test-reporter-destination=stdout',
    ...
    'tests/seeded-race.test.ts', 'tests/touch-controls.test.tsx', 'tests/guide-text.test.ts', 'tests/gamepad.test.ts', 'tests/hit-feedback.test.ts', 'tests/gap-readout.test.ts', 'tests/wall-scrape.test.ts'],
];
