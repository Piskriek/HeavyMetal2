 ...
 * task's cost would pass MESHY_CEILING (default 2000). Outputs land in art-src/meshy/<name>/
...
/** The owner's ceiling (2026-09-26: raised to 2000; the account holds 2021 credits in all). */
const CEILING = Number(process.env.MESHY_CEILING ?? 2000);
