...
const ICON_ROOT = '/art/ui/icons/builder-prim-';

const SHAPES: readonly ShapeInfo[] = [
  { shape: 'box', name: 'Box', size: [400, 400, 400], icon: `${ICON_ROOT}box.png` },
  { shape: 'sphere', name: 'Sphere', size: [400, 400, 400], icon: `${ICON_ROOT}sphere.png` },
  { shape: 'cylinder', name: 'Cylinder', size: [300, 500, 300], icon: `${ICON_ROOT}cylinder.png` },
  { shape: 'cone', name: 'Cone', size: [400, 500, 400], icon: `${ICON_ROOT}cone.png` },
  { shape: 'torus', name: 'Ring', size: [500, 500, 160], icon: `${ICON_ROOT}torus.png` },
  { shape: 'ramp', name: 'Wedge', size: [400, 200, 600], icon: `${ICON_ROOT}wedge.png` },
  { shape: 'plane', name: 'Flat panel', size: [800, 10, 800], icon: `${ICON_ROOT}panel.png` },
  { shape: 'rock', name: 'Rock', size: [420, 320, 380], icon: `${ICON_ROOT}rock.png` },
  { shape: 'capsule', name: 'Capsule', size: [200, 500, 200], icon: `${ICON_ROOT}capsule.png` },
  { shape: 'arch', name: 'Arch', size: [600, 400, 160], icon: `${ICON_ROOT}arch.png` },
];
