...
function makeSeamlessMaterial(texture: THREE.Texture, extra: THREE.MeshStandardMaterialParameters = {}) {
  // Keep the repeat tile readable and quiet. The previous material sampled three
  // rotated copies of the texture and selected between them with luminance noise;
  // that made every surface busier and higher-contrast than the painted scenery.
  // The tile itself is now the complete look, with normal RepeatWrapping providing
  // the seamless world-space coverage.
